...
constexpr auto ENC_A  = 2;   // PinA
constexpr auto ENC_B  = 3;   // PinB
constexpr auto ENC_SW = 12;  // Button Pin
constexpr auto SNSTVY = 2;   // Sensitivity (clicks per notch)

ClickEncoder clickEncoder(ENC_A, ENC_B, ENC_SW, SNSTVY);
ClickEncoderInterface clickEnc(clickEncoder, SNSTVY);
